...
(function (EO) {
  ...
  var STREAMS = [
    ...
    { from: "deg", to: "storage", fs: "r", ts: "l", toff: 0.13, type: "product", label: "DEG" },
    { from: "teg", to: "storage", fs: "r", ts: "l", toff: 0.21, type: "product", label: "TEG" },
    { from: "mea", to: "storage", fs: "r", ts: "l", toff: 0.38, type: "product", label: "MEA" },
    { from: "dea", to: "storage", fs: "r", ts: "l", toff: 0.46, type: "product", label: "DEA" },
    { from: "tea", to: "storage", fs: "r", ts: "l", toff: 0.54, type: "product", label: "TEA" },
    { from: "ethoxylation", to: "storage", fs: "r", ts: "l", toff: 0.73, type: "product", label: "Ethoxylates" },
    { from: "polyols", to: "storage", fs: "r", ts: "l", toff: 0.93, type: "product", label: "Polyols" },
