...
(function (EO) {
  ...
  var STREAMS = [
    ...
    // ---- EOP → ethanolamines MEA · DEA · TEA (own boxes) + other product units ----
    ...
    { from: "meg", to: "storage", fs: "r", ts: "l", toff: 0.02, type: "product", label: "MEG" },
    { from: "deg", to: "storage", fs: "r", ts: "l", toff: 0.10, type: "product", label: "DEG" },
    { from: "teg", to: "storage", fs: "r", ts: "l", toff: 0.18, type: "product", label: "TEG" },
    { from: "mea", to: "storage", fs: "r", ts: "l", toff: 0.30, type: "product", label: "MEA" },
    { from: "dea", to: "storage", fs: "r", ts: "l", toff: 0.38, type: "product", label: "DEA" },
    { from: "tea", to: "storage", fs: "r", ts: "l", toff: 0.46, type: "product", label: "TEA" },
    { from: "ethoxylation", to: "storage", fs: "r", ts: "l", toff: 0.58, type: "product", label: "Ethoxylates" },
    { from: "peg", to: "storage", fs: "r", ts: "l", toff: 0.70, type: "product", label: "PEG" },
    { from: "glycolethers", to: "storage", fs: "r", ts: "l", toff: 0.82, type: "product", label: "Glycol ethers" },
    { from: "polyols", to: "storage", fs: "r", ts: "l", toff: 0.94, type: "product", label: "Polyols" },
  ...
  /* ---------------------------------------------------------------
     ...
     --------------------------------------------------------------- */
  var STAGE_ORDER = ["feedstocks", "furnace", "quench", "treatment", "cryo", "eoreactor", "eorecovery", "eop", "eg", "meg", "deg", "teg", "mea", "dea", "tea", "ethoxylation", "peg", "glycolethers", "polyols", "storage", "trade"];
